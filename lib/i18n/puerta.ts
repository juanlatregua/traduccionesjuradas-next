...
export const puertaT: Record<PuertaLang, PuertaStrings> = {
  ...
  de: {
    locale: "de-DE",
    cutoffBefore: (r) => `Bestellen Sie vor 18:00 Uhr und wir starten noch heute — ${r} übrig.`,
    ...
    contactTitle: "Wohin sollen wir Sie benachrichtigen, wenn sie fertig ist?",
  ...
  pt: {
    ...
    neededByLabel: "Para quando precisa?",
    neededByHelp: "Opcional. Ajuda-nos a confirmar se o prazo chega à sua data.",
    neededForPrefix: "Precisa dele para",
    totalLabel: (n) => `Total (${n} documentos)`,
    ...
    contactWhatsApp: "Contactar por WhatsApp",
    whatsappPrefill: "Olá, tenho uma dúvida sobre um orçamento de tradução juramentada.",
    gdprConsent: "Consinto o tratamento dos meus documentos para gerar um orçamento de tradução juramentada. Os documentos são eliminados automaticamente 30 dias após a entrega.",
    ...
    qSworn: "Precisa de tradução juramentada?",
    qPrice: "Preço",
    ...
    deliveryEstimated: "Entrega estimada:",
    onTimeYes: "Chega à data que precisa",
    onTimeNo: "A sua data é muito apertada. Escreva-nos e vemos como acelerar.",
    maecCredential: "Assinada por um tradutor juramentado acreditado pelo MAEC — validade oficial.",
