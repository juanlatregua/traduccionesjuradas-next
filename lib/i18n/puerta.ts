...
export const puertaT: Record<PuertaLang, PuertaStrings> = {
  es: {
    ...
    requestQuoteDoneLavori: "Tu documento ya está con un traductor jurado de {lang} nombrado por el Ministerio de Asuntos Exteriores. Te enviamos el presupuesto en breve, normalmente en el día.",
  ...
  fr: {
    ...
    requestQuoteDoneLavori: "Votre document est déjà entre les mains d'un traducteur assermenté ({lang}) nommé par le ministère des Affaires étrangères. Vous recevrez le devis très prochainement, en général dans la journée.",
  ...
  en: {
    ...
    requestQuoteDoneLavori: "Your document is already with a sworn {lang} translator appointed by the Spanish Ministry of Foreign Affairs. We will send you the quote shortly, usually the same day.",
  ...
  de: {
    ...
    requestQuoteDoneLavori: "Ihr Dokument liegt bereits einem vom spanischen Außenministerium vereidigten Übersetzer ({lang}) vor. Sie erhalten das Angebot in Kürze, in der Regel noch am selben Tag.",
  ...
  pt: {
    ...
    requestQuoteDoneLavori: "O seu documento já está com um tradutor ajuramentado de {lang} nomeado pelo Ministério dos Negócios Estrangeiros. Enviamos-lhe o orçamento em breve, normalmente no próprio dia.",
