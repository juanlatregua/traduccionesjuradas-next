  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm text-sepia">
      ...
      <section className="mt-6 space-y-6">
        <div>
          <h2 className="text-lg font-semibold text-encre">1. Aviso Legal</h2>

          <h3 className="mt-4 font-semibold text-encre">1.1 Información general</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-encre">1.2 Objeto</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-encre">1.3 Condiciones de uso</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-encre">1.4 Propiedad intelectual e industrial</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-encre">1.5 Responsabilidad</h3>
          <p className="mt-2">
