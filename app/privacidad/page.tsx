  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm text-slate-700">
      ...
      <section className="mt-6 space-y-6">
        <div>
          <h2 className="text-lg font-semibold text-slate-900">2. Política de Privacidad</h2>

          <h3 className="mt-4 font-semibold text-slate-900">2.1 Responsable del tratamiento</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.2 Datos personales tratados</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.3 Finalidad del tratamiento</h3>
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.4 Legitimación</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.5 Conservación de los datos</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.6 Cesión de datos</h3>
          <p className="mt-2">
          ...
          <h3 className="mt-6 font-semibold text-slate-900">2.7 Derechos del usuario</h3>
          <p className="mt-2">
