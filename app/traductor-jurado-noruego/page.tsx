...
export default function TraductorJuradoNoruegoPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 lg:py-12">
      <SchemaBreadcrumbs
        id="breadcrumbs-traductor-jurado-noruego"
        items={[
          { name: "Inicio", url: "https://www.traduccionesjuradas.net/" },
          { name: "Traductor jurado de noruego", url: "https://www.traduccionesjuradas.net/traductor-jurado-noruego" },
        ]}
      />
      <SchemaFAQ
        id="faq-traductor-jurado-noruego"
        items={[
          {
      ...
      {/* PANEL DE PEDIDO */}
      <LanguageOfferPanel config={LANGUAGE_CONFIGS.noruego} />
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        <article className="rounded-2xl border border-slate-200 bg-white p-4 text-sm shadow-sm">
          <h2 className="text-base font-semibold text-slate-900">
            Precio de traducción jurada de noruego
          </h2>
