...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/api/og?title=Traductor+jurado+de+noruego&subtitle=Traducci%C3%B3n+jurada+oficial+NO+%E2%86%94+ES",
        width: 1200,
        height: 630,
        alt: "Traductor jurado de noruego — TraduccionesJuradas.net",
      },
    ],
  },
};
