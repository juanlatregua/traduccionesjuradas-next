#!/usr/bin/env node
// gsc-top-queries.mjs — top queries de Search Console
// Uso: node scripts/seo/gsc-top-queries.mjs [--days=28] [--limit=20] [--json]
...
console.log(`GSC top queries · ${range.startDate} → ${range.endDate}\n`);
