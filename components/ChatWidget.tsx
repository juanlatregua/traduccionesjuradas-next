      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between rounded-t-none bg-bleu px-4 py-3 sm:rounded-t-2xl">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="rounded p-1.5 text-parchment/70 transition-colors hover:bg-white/10 hover:text-parchment"
          ...
          >
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {QUICK_REPLIES.map((reply) => (
                  <button
                    ...
                    className="rounded-full border border-bleu/20 bg-card px-3 py-1.5 text-xs font-medium text-bleu transition-colors hover:bg-bleu hover:text-parchment"
                  >
            ...
            {/* Rate limit message */}
            {rateLimited && (
              <div className="rounded-lg border border-or/30 bg-cream p-3 text-center text-sm text-sepia">
                <p className="mb-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#20bd5a]"
                >
          ...
          {!rateLimited && (
            <form
              ...
              className="flex items-end gap-2 border-t border-cream bg-card px-3 py-2 sm:rounded-b-2xl"
            >
              <textarea
                ref={inputRef}
                value={input}
              ...
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-bleu text-parchment transition-colors hover:bg-bleu-dark disabled:opacity-40"
              >
