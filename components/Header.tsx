      ...
      <div className="mx-auto max-w-6xl px-4 py-4 sm:flex sm:items-center sm:gap-6">
        <div className="flex items-center justify-between gap-3 sm:flex sm:flex-1 sm:items-center">
          ...
          >
            <span className="relative flex h-4 w-4 flex-col items-center justify-center" aria-hidden="true">
              <span
                className={`absolute block h-[2px] w-4 bg-slate-700 transition-transform duration-200 ${
                  menuOpen ? "rotate-45" : "-translate-y-[5px]"
                }`}
              />
              <span
                className={`absolute block h-[2px] w-4 bg-slate-700 transition-opacity duration-200 ${
        ...
        >
          ...
          <div className="relative hidden sm:block" ref={translatorRef}>
            ...
            <div
              className={`absolute right-0 top-full w-72 max-h-[60vh] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-3 text-xs text-slate-700 shadow-lg transition ${
          ...
          <div className="relative hidden sm:block" ref={docsRef}>
            ...
            <div
              className={`absolute left-0 top-full w-72 max-h-[60vh] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-3 text-xs text-slate-700 shadow-lg transition ${
                docsDropdownOpen
                  ? "pointer-events-auto opacity-100"
                  : "pointer-events-none opacity-0"
              }`}
